...
// 🔥 SALIR DE LANDSCAPE (ANDROID)
if (window.Android) {
  Android.setPortrait();
}

// 🔥 SALIR DE FULLSCREEN WEB
exitFullscreen();
...
const img = document.getElementById("favoritoImagen")?.src || "";

if (typeof Android !== "undefined") {

  // 🔥 importante: tipo = movie
  const data = "Película|" + nombre + "|" + img + "|movie";
