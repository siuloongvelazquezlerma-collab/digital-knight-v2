window.suggestionsLibrary = [
...

  {
    ...
    type: "recommended",
    label: "Recomendado para ti",
    title: "Bardock: El Legendario Super Saiyajin",
  ...
  {
    id: "bill-teds-excellent-adventure",
    type: "recommended",
    label: "Recomendado para ti",
  ...
  {
    id: "dragon-ball-z-bardock",
    type: "recommended",
    label: "Recomendado para ti",
    title: "Dragon Ball Z OVA: La Batalla de Freezer contra el Padre de Goku",
  ...
  {
    id: "dragon-ball-z-history-of-trunks",
    type: "recommended",
    label: "Recomendado para ti",
    title: "Dragon Ball Z OVA: Los Guerreros del Futuro",
  ...
  {
    id: "dragon-ball-z-movie-6",
    type: "recommended",
    label: "Recomendado para ti",
    title: "Dragon Ball Z: Los Guerreros Más Poderosos",
  ...
  {
    id: "dragon-ball-z-broly-second-coming",
    type: "recommended",
    label: "Recomendado para ti",
    title: "Dragon Ball Z: El Regreso del Guerrero Legendario",
  ...
  {
    id: "dragon-ball-path-to-power",
    type: "recommended",
    label: "Recomendado para ti",
    title: "Dragon Ball: Camino hacia el Poder",
...
{
  id: "el-planeta-de-los-simios-confrontacion",
  type: "recommended",
  label: "Recomendado para ti",
...
{
  id: "el-planeta-de-los-simios-nuevo-reino",
  type: "recommended",
  label: "Recomendado para ti",
...
{
  id: "encuentros-cercanos-del-tercer-tipo",
  type: "recommended",
  label: "Recomendado para ti",
...
{
  id: "flintstones-in-viva-rock-vegas",
  type: "recommended",
  label: "Recomendado para ti",
...
{
  id: "ghostbusters-apocalipsis-fantasma",
  type: "recommended",
  label: "Recomendado para ti",
...
{
  id: "harry-potter-20-aniversario-regreso-a-hogwarts",
  type: "recommended",
  label: "Recomendado para ti",
...
{
  id: "harry-potter-y-el-caliz-de-fuego",
  type: "recommended",
  label: "Recomendado para ti",
...
{
  id: "harry-potter-y-el-misterio-del-principe",
  type: "recommended",
  label: "Recomendado para ti",
...
{
  id: "harry-potter-y-el-prisionero-de-azkaban",
  type: "recommended",
  label: "Recomendado para ti",
...
{
  id: "harry-potter-y-la-camara-secreta",
  type: "recommended",
  label: "Recomendado para ti",
...
{
  id: "harry-potter-y-la-orden-del-fenix",
  type: "recommended",
  label: "Recomendado para ti",
...
{
  id: "harry-potter-y-las-reliquias-de-la-muerte-parte-1",
  type: "recommended",
  label: "Recomendado para ti",
...
{
  id: "imaginario-juguete-diabolico",
  type: "recommended",
  label: "Recomendado para ti",
...
{
  id: "krakens-y-sirenas-conoce-a-los-gillman",
  type: "recommended",
  label: "Recomendado para ti",
...
{
  id: "la-casa-del-fin-de-los-tiempos",
  type: "recommended",
  label: "Recomendado para ti",
  title: "La Casa del Fin de los Tiempos",
  description: "",
...
{
  id: "locos-por-las-nueces-2",
  type: "recommended",
  label: "Recomendado para ti",
  title: "Locos por las Nueces 2",
  description: "",
...
{
  id: "los-caballeros-del-zodiaco-la-leyenda-del-santuario",
  type: "recommended",
  label: "Recomendado para ti",
  title: "Los Caballeros del Zodiaco: La Leyenda del Santuario",
  description: "",
...
{
  id: "los-pinguinos-de-madagascar",
  type: "recommended",
  label: "Recomendado para ti",
...
{
  id: "mighty-morphin-power-rangers-la-pelicula",
  type: "recommended",
  label: "Recomendado para ti",
  title: "Mighty Morphin Power Rangers: La Película",
  description: "",
...
{
  id: "paw-patrol-la-super-pelicula",
  type: "recommended",
  label: "Recomendado para ti",
...
{
  id: "rapidos-y-furiosos-reto-tokio",
  type: "recommended",
  label: "Recomendado para ti",
...
{
  id: "rebel-moon-parte-dos",
  type: "recommended",
  label: "Recomendado para ti",
  title: "Rebel Moon: Parte Dos",
...
{
  id: "resident-evil-el-huesped-maldito",
  type: "recommended",
  label: "Recomendado para ti",
...
{
  id: "the-american-society-of-magical-negroes",
  type: "recommended",
  label: "Recomendado para ti",
...
{
  id: "dragon-ball-movie-1",
  type: "recommended",
  label: "Recomendado para ti",
  title: "Dragon Ball: La Leyenda de Shenlong",
  description: "",
...
{
  id: "dragon-ball-movie-2",
  type: "recommended",
  label: "Recomendado para ti",
  title: "Dragon Ball: La Princesa Durmiente del Castillo Embrujado",
  description: "",
...
{
  id: "dragon-ball-movie-3",
  type: "recommended",
  label: "Recomendado para ti",
  title: "Dragon Ball: Una Aventura Mística",
  description: "",
...
{
  id: "dragon-ball-z-movie-1",
  type: "recommended",
  label: "Recomendado para ti",
  title: "Dragon Ball Z: ¡Devuélvanme a mi Gohan!",
  description: "",
...
{
  id: "dragon-ball-z-movie-2",
  type: "recommended",
  label: "Recomendado para ti",
  title: "Dragon Ball Z: El Hombre Más Fuerte de Este Mundo",
  description: "",
...
{
  id: "dragon-ball-z-movie-3",
  type: "recommended",
  label: "Recomendado para ti",
  title: "Dragon Ball Z: La Batalla Más Grande del Mundo Está por Comenzar",
  description: "",
...
{
  id: "dragon-ball-z-movie-4",
  type: "recommended",
  label: "Recomendado para ti",
  title: "Dragon Ball Z: Gokú es un Super Saiyajin",
  description: "",
...
{
  id: "dragon-ball-z-movie-5",
  type: "recommended",
  label: "Recomendado para ti",
  title: "Dragon Ball Z: Los Rivales Más Poderosos",
  description: "",
...
{
  id: "dragon-ball-z-movie-7",
  type: "recommended",
  label: "Recomendado para ti",
  title: "Dragon Ball Z: La Pelea de los 3 Saiyajin",
  description: "",
...
{
  id: "dragon-ball-z-movie-8",
  type: "recommended",
  label: "Recomendado para ti",
  title: "Dragon Ball Z: El Poder Invencible",
  description: "",
...
{
  id: "dragon-ball-z-movie-9",
  type: "recommended",
  label: "Recomendado para ti",
  title: "Dragon Ball Z: La Galaxia Corre Peligro",
  description: "",
...
{
  id: "dragon-ball-z-movie-11",
  type: "recommended",
  label: "Recomendado para ti",
  title: "Dragon Ball Z: El Combate Final",
  description: "",
...
{
  id: "dragon-ball-z-movie-12",
  type: "recommended",
  label: "Recomendado para ti",
  title: "Dragon Ball Z: La Fusión de Gokú y Vegeta",
  description: "",
...

{
  ...
  type: "recommended",
  label: "Recomendado para ti",
  title: "Troll 3: Se Armó la Banda",
  description: "",
